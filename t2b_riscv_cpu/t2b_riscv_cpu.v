...
//data_mem dmem (clk, MemWrite, DataAdr, WriteData, Store, ReadData, CPU_DONE);
//mem_div  mem_dijkstra(clk, CPU_DONE, ReadData);
//
//// output assignments
...
instr_mem imem (PC, Instr);
data_mem dmem (clk, MemWrite, DataAdr, WriteData, Store, ReadData, CPU_DONE);
mem_div mem_dijkstra(clk, CPU_DONE, ReadData, rd_sub_mem0, rd_sub_mem1, rd_sub_mem2, rd_sub_mem3);
